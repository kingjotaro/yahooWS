...
(async() => { 
  ...
  async function reqAnswer(){ 
    try {
      ...
      const openEvalAnswer =  await aberturaRes.evaluate((element) => element.textContent);
      ...
      const maxEvalAnswer = await maximaRes.evaluate((element) => element.textContent);
      ...
      const minEvalAnswer = await minimaRes.evaluate((element) => element.textContent);
      ...
      const closeEvalAnswer = await fechamentoRes.evaluate((element) => element.textContent);
      ...
      const priceAjstEvalAnswer = await preçoAjtsRes.evaluate((element) => element.textContent);
      ...
      const volEvalAnswer = await volumeRes.evaluate((element) => element.textContent);
